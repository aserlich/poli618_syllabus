...
E-mail: $if(email)$\texttt{$email$}$else$TBD$endif$ & Phone: $if(phone)${\texttt $phone$}$else$TBD$endif$\\
...
TA: $if(TA.name)$\textbf{$TA.name$}$else$TBD$endif$ & E-mail: $if(TA.email)$\texttt{$TA.email$}$else$TBD$endif$ \\
Office Hours: $if(TA.officehours)$$TA.officehours$$else$TBD$endif$  &
                                                                   Conference
                                                                       Hours:
                                                                       $if(TA.conferencehours)$$TA.conferencehours$$else$Check
                                                                       your
                                                                       schedule$endif$\\
Office: $if(TA.office)$$TA.office$$else$TBD$endif$  &  Conference Room: $if(TA.conferenceroom)$$TA.conferenceroom$$else$Check
                                                         your schedule$endif$ \\ 
	\hline
\end{tabular*}	
\vspace{10mm}
